...
as $$
  select '{"vehicle":null,"grade":null,"payment":null,"color":null,"order_now":null,"accessories":null,"purchase":null,"rep_time":null,"timing":null}'::jsonb
$$;
...
as $$
  select case
    ...
    when p->'grade' is null or p->'grade' = 'null'::jsonb then 'grade'
...
alter table public.leads add constraint leads_current_step_check
  check (current_step in (
    'channel', 'vehicle', 'grade', 'payment', 'color', 'order_now',
