-- Cash + accepted order asks online or telesales, then closes hot.
...
as $$
  select '{"vehicle":null,"payment":null,"color":null,"order_now":null,"accessories":null,"purchase":null,"timing":null}'::jsonb
$$;
...
alter table public.leads add constraint leads_current_step_check
  check (current_step in (
    ...
    'accessories', 'purchase', 'timing', 'close', 'done'
  ));
